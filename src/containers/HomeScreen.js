...
const HomeScreen = ({navigation}) => {
    ...
    const searchcustomer = () => {
        if (searchvalue == '') {
            setisLoading(false);
            return Alert.alert('OOPS!', 'Please Enter Customer Account No', [
                {text: 'Okay'},
            ]);
        } else {
            setisLoading(true);
                ...
                fetch('https://opflextest.nurighana.com/api/search_customer', {
                    ...
                    .then(resource => {
                        ...
                        if (resource.status == 'Success') {
                            ...
                            return Alert.alert('OOPS!', 'No Data Found', [
                                {text: 'Okay'},
                            ]);
                        }
                        if (resource.data == '') {
    ...
    const renderList = ({item, index}) => {
        ...
        return (
            <TouchableOpacity
                onPress={() =>
                    navigation.push('ServiceDetails', {number: item.account_no})
                }
            >
                <View
                    style={{
